...
ui <- dashboardPage(
  ...
  skin='blue',
  title="NRMP MIS Data Checking App",
...
server <- function(input, output,session) {
  ...
  data <- reactive({
    ...
    targetsps=c("BOBCATS","COYOTES","FOXES, GRAY","FOXES, ARCTIC","FOXES, RED","RACCOONS","SKUNKS, STRIPED","SKUNKS, SPOTTED","SKUNKS, HOG-NOSED","SKUNKS, HOODED")
